...
export async function registerUser(
  ...
  try {
    ...
    const registrationSchema = z.object({
      ...
      password: z
        .string()
        .min(8, { message: t("validation.errors.passwordMin") }),
    });
    ...
    if (!validated.success) {
      return {
        success: false,
        toastTitle: t("errors.validation.title"),
        toastDescription: t("errors.validation.description"),
        toastType: "error",
      };
    }
    ...
    if (existingUser) {
      return {
        success: false,
        toastTitle: t("errors.userExists.title"),
        toastDescription: t("errors.userExists.description"),
        toastType: "error",
      };
    }
