...
export const createCredentialsSchema = (t?: TranslationFunction) =>
  z.object({
    username: z
      ...
      .min(
        1,
        t ? t("validation.errors.usernameRequired") : "Username is required"
      ),
    password: z
      .string()
      .min(
        1,
        t ? t("validation.errors.passwordRequired") : "Password is required"
      ),
  });
...
const createBaseProfileSchema = (t?: TranslationFunction) =>
  z.object({
    ...
    email: z.email(
      t ? t("validation.errors.emailInvalid") : "Invalid email address"
    ),
  });
...
export const createUserProfileSchema = (t?: TranslationFunction) =>
  createBaseProfileSchema(t).partial();

/**
 * Profile form schema (all fields required for form validation)
 */
export const createProfileFormSchema = (t?: TranslationFunction) =>
    ...
    .extend({
      confirmPassword: z
        ...
        .min(
          1,
          t
            ? t("validation.errors.confirmPasswordRequired")
            : "Please confirm your password"
        ),
    })
    .refine((data) => data.password === data.confirmPassword, {
      message: t
        ? t("validation.errors.passwordsNotMatch")
...
// Type exports
export type CredentialsInput = z.infer<
  ReturnType<typeof createCredentialsSchema>
>;
export type UserProfileUpdateInput = z.infer<
  ReturnType<typeof createUserProfileSchema>
>;
