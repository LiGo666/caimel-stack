...
import { FinalizeUploadInput, FinalizeUploadSchema } from "../schemas/upload-schemas"

export async function finalizeUpload(params: FinalizeUploadInput): Promise<ApiResponse> {
  ...
  try {
    ...
    // Validate input
    const validation = FinalizeUploadSchema.safeParse(params)
