...
} from "../lib/file-upload-session-manager";
  ...
  try {
    ...
    if (sessions.length > 0) {
      ...
      if (directResults.length > 0) {
        console.log(
          "First direct result:",
          JSON.stringify(directResults[0], null, 2)
        );
      }
    }
    ...
    return {
      success: false,
      toastTitle: "Error",
      toastDescription: "Failed to fetch upload sessions",
      toastType: "error",
      errorCode: "UPLOAD-001",
    };
  }
}
 ...
 */
export async function getUploadSessionsByStatusAction(
  status: FileStatus
): Promise<ApiResponse> {
  try {
 ...
 */
export async function deleteUploadSessionAction(
  data: z.infer<typeof deleteSessionSchema>
): Promise<ApiResponse> {
  try {
    // Validate input
    ...
    if (!session) {
      return {
        success: false,
        toastTitle: "Error",
        toastDescription: "Upload session not found",
        toastType: "error",
        errorCode: "UPLOAD-003",
      };
    }
    ...
    return {
      success: true,
      toastTitle: "Success",
      toastDescription: "Upload session marked as deleted",
      toastType: "success",
    };
  } catch (error) {
    ...
    return {
      success: false,
      toastTitle: "Error",
      toastDescription: "Failed to delete upload session",
      toastType: "error",
      errorCode: "UPLOAD-004",
    };
  }
}
...
export async function retryJobAction(
  data: z.infer<typeof retryJobSchema>
): Promise<ApiResponse> {
  try {
    // Validate input
    ...
    return {
      success: true,
      toastTitle: "Success",
      toastDescription: "Job has been queued for retry",
      toastType: "success",
    };
  } catch (error) {
    ...
    return {
      success: false,
      toastTitle: "Error",
      toastDescription: "Failed to retry job",
      toastType: "error",
      errorCode: "UPLOAD-005",
    };
  }
}
...
export async function getJobStatsAction(): Promise<ApiResponse> {
  try {
    ...
    return {
      success: false,
      toastTitle: "Error",
      toastDescription: "Failed to fetch job statistics",
      toastType: "error",
      errorCode: "UPLOAD-006",
    };
  }
}
