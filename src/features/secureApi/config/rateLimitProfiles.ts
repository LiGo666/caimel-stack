export type RateLimitScenarioType = "SECURE_ENDPOINTS" | "GENERAL_ENDPOINTS" | "TESTING_ENVIRONMENT"
...
export const rateLimitProfiles: Record<RateLimitScenarioType, RateLimitProfile> = {
