...
export const toast = {
   Success: (title: string, options: ExternalToast = {}) => {
      return originalToast.success(title, { ...options, position: "bottom-center" })
   },
 ...
 */
export function toastify(result: Partial<ToastProps> & { errorCode?: string }): void {
   if (result.errorCode) {
   ...
   switch (result.toastType) {
      case "success":
         toast.Success(result.toastTitle, { description: result.toastDescription })
         break
      case "error":
         toast.Error(result.toastTitle, { description: result.toastDescription })
         break
      case "warning":
         toast.Warning(result.toastTitle, { description: result.toastDescription })
         break
      case "info":
         toast.Info(result.toastTitle, { description: result.toastDescription })
         break
      default:
         toast.Default(result.toastTitle, { description: result.toastDescription })
   }
}
